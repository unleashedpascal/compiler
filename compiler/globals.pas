    ...
    const
       delphimodeswitches =
         [m_delphi,m_class,m_objpas,m_result,m_string_pchar,
          ...
          m_statement_expressions,m_reordered_operators,m_implicit_generics];
       ...
       unleashedmodeswitches = objfpcmodeswitches+[m_default_ansistring,m_underscoreisseparator,m_duplicate_names,
        ...
        m_autoproperties,m_lock,m_asyncawait,m_parallelfor,m_int128,m_out_var,m_prepost_incdec,m_reordered_operators,m_unleashed];
       tpmodeswitches =
